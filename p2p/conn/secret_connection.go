...
import (
	...
	"github.com/airchains-network/tracksbft/libs/async"
...
// See https:// github.com/airchains-network/tracksbft/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https:// github.com/airchains-network/tracksbft/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https:// github.com/airchains-network/tracksbft/issues/3531
