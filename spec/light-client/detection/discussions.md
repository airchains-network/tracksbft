...
- Generating a minimal proof of fork (as suggested in [Issue #5083](https://github.com/airchains-network/tracksbft/issues/5083)) is too costly at the light client
